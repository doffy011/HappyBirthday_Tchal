...
function goToSection3() {
  const video = document.querySelector(".fireworks-video");
  video.muted = true; // 🔇 mute sound when button clicked
...
// Flip the card
function toggleCard() {
  document.querySelector('.book-card').classList.toggle('open');
}

// Section 3 ➜ Section 4 (via gift emoji)
